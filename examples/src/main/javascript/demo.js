...
// This file shows how to use bitcoingoldj from Javascript.
// To run, grab the bitcoingoldj bundled JAR and then do something like this:
//
//   jjs -cp bitcoingoldj-0.12-bundled.jar demo.js
//
...
//
//   jjs -cp bitcoingoldj-0.12-bundled.jar
//
...
//
//   jjs -cp bitcoingoldj-0.12-bundled.jar:$slf4fj demo.js
//
...
// Nashorn, unlike V8, is thread safe (because it runs on the JVM). And bitcoingoldj is a threaded library. This means you
