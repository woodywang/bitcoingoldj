...
/**
 * <p>A reusable object that will calculate, given a list of {@link org.bitcoingoldj.core.PeerFilterProvider}s, a merged
 * {@link org.bitcoingoldj.core.BloomFilter} and earliest key time for all of them.
 * Used by the {@link org.bitcoingoldj.core.PeerGroup} class internally.</p>
 *
