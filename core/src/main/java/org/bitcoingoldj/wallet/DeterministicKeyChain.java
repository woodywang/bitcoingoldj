 ...
 * {@link org.bitcoingoldj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link org.bitcoingoldj.crypto.MnemonicCode},
 ...
 * {@link org.bitcoingoldj.crypto.DeterministicKey#serializePubB58(org.bitcoingoldj.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link org.bitcoingoldj.crypto.DeterministicKey#deserializeB58(org.bitcoingoldj.crypto.DeterministicKey, String, org.bitcoingoldj.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(org.bitcoingoldj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link org.bitcoingoldj.crypto.DeterministicHierarchy} and
 * {@link org.bitcoingoldj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
    ...
    public List<DeterministicKey> getKeys(KeyPurpose purpose, int numberOfKeys) {
        ...
        try {
            ...
            for (int i = 0; i < numberOfKeys; i++) {
                ...
                // by any real problem reports from bitcoingoldj users, but I've heard of cases via the grapevine of
     ...
     * The returned key can be serialized and then passed into {@link #watch(org.bitcoingoldj.crypto.DeterministicKey)}
     ...
     * @see org.bitcoingoldj.wallet.MarriedKeyChain
     */
