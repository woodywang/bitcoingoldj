...
import org.bitcoingold.protocols.payments.Protos.PaymentDetails;
...
import org.bitcoingoldj.wallet.KeyChain.KeyPurpose;
import org.bitcoingoldj.wallet.Wallet.MissingSigsMode;
...
public class SendRequest {
     ...
     * (its value is ignored and set to {@link org.bitcoingoldj.wallet.Wallet#getBalance()} - the fees required
    ...
    /**
     * If not null, the {@link org.bitcoingoldj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
