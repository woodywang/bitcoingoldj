...
import org.bitcoingoldj.core.Message;
import org.bitcoingoldj.core.NetworkParameters;
import org.bitcoingoldj.core.Peer;
import org.bitcoingoldj.core.PeerFilterProvider;
...
import org.bitcoingoldj.core.TransactionBag;
import org.bitcoingoldj.core.TransactionBroadcast;
...
import org.bitcoingoldj.core.TransactionOutPoint;
import org.bitcoingoldj.core.TransactionOutput;
import org.bitcoingoldj.core.UTXO;
import org.bitcoingoldj.core.UTXOProvider;
import org.bitcoingoldj.core.UTXOProviderException;
...
import org.bitcoingoldj.signers.*;
import org.bitcoingoldj.utils.*;
import org.bitcoingoldj.wallet.Protos.Wallet.*;
...
import org.bitcoingoldj.wallet.listeners.WalletEventListener;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.bitcoingoldj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link org.bitcoingoldj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.bitcoingoldj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bitcoingoldj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.bitcoingoldj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.bitcoingoldj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bitcoingoldj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.bitcoingoldj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.bitcoingoldj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.bitcoingoldj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bitcoingoldj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.bitcoingoldj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.bitcoingoldj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bitcoingoldj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of bitcoingoldj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.bitcoingoldj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.bitcoingoldj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.bitcoingoldj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.bitcoingoldj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.bitcoingoldj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.bitcoingoldj.crypto.KeyCrypter,
     ...
     * {@link org.bitcoingoldj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.bitcoingoldj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.bitcoingoldj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.bitcoingoldj.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.bitcoingoldj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.bitcoingoldj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
