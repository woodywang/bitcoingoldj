...
/**
 * <p>A KeyChainGroup is used by the {@link org.bitcoingoldj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.bitcoingoldj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.bitcoingoldj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.bitcoingoldj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
