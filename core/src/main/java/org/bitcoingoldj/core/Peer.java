...
import org.bitcoingoldj.net.StreamConnection;
import org.bitcoingoldj.store.BlockStore;
import org.bitcoingoldj.store.BlockStoreException;
import org.bitcoingoldj.utils.ListenerRegistration;
 ...
 * {@link org.bitcoingoldj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link org.bitcoingoldj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link org.bitcoingoldj.net.NioClientManager#openConnection(java.net.SocketAddress, StreamConnection)}
     * or
     * {@link org.bitcoingoldj.net.NioClient#NioClient(java.net.SocketAddress, StreamConnection, int)}.</p>
     *
    ...
    /**
     * <p>Construct a peer that reads/writes from the given block chain. Transactions stored in a {@link org.bitcoingoldj.core.TxConfidenceTable}
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        // bitcoingoldj is a client mode implementation. That means there's not much point in us talking to other client
     ...
     * Once the pong is received the value returned by {@link org.bitcoingoldj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link org.bitcoingoldj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link org.bitcoingoldj.core.Peer#ping()} has never
