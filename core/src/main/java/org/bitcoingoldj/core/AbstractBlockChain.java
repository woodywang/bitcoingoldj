 ...
 * the lightweight SPV mode, a {@link org.bitcoingoldj.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link org.bitcoingoldj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to
