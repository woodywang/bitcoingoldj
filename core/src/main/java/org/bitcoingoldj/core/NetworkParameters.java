...
import org.bitcoingoldj.utils.VersionTally;
...
public abstract class NetworkParameters {
    ...
    public static final String ID_MAINNET = "org.bitcoingold.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_TESTNET = "org.bitcoingold.test";
    /** The string returned by getId() for regtest mode. */
    public static final String ID_REGTEST = "org.bitcoingold.regtest";
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "org.bitcoingoldj.unittest";
    ...
    /** Returns discovery objects for seeds implementing the Cartographer protocol. See {@link org.bitcoingoldj.net.discovery.HttpDiscovery} for more info. */
    ...
    /**
     * First byte of a base58 encoded address. See {@link org.bitcoingoldj.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link org.bitcoingoldj.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link org.bitcoingoldj.core.AlertMessage}s. You can use {@link org.bitcoingoldj.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
