...
import org.bitcoingoldj.script.ScriptOpCodes;
import org.bitcoingoldj.signers.TransactionSigner;
import org.bitcoingoldj.utils.ExchangeRate;
...
import static org.bitcoingoldj.core.Utils.*;
...
public class Transaction extends ChildMessage {
    ...
    public static final int BTG_FORKID = 79;
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, org.bitcoingoldj.script.Script, ECKey, org.bitcoingoldj.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], org.bitcoingoldj.core.Transaction.SigHash, boolean)}
    ...
    Sha256Hash hashForSignature(int inputIndex, byte[] connectedScript, int sigHashType) {
        ...
        try {
            ...
            uint32ToByteStreamLE(0x0000ffff & sigHashType, baos);
    ...
    /**
     * Returns the confidence object for this transaction from the {@link org.bitcoingoldj.core.TxConfidenceTable}
