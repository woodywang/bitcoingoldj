...
import org.bitcoingoldj.net.discovery.*;
...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of bitcoingoldj fixes the known
     ...
     * {@link org.bitcoingoldj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.bitcoingoldj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.bitcoingoldj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.bitcoingoldj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.bitcoingoldj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.bitcoingoldj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.bitcoingoldj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.bitcoingoldj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.bitcoingoldj.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a bitcoingoldj based app running in SPV mode to fully validating security.
     */
