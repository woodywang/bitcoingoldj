...
import org.bitcoingoldj.net.NioClient;
import org.bitcoingoldj.net.ProtobufConnection;
import org.bitcoingoldj.protocols.channels.IPaymentChannelClient.ClientChannelProperties;
...
public class PaymentChannelClientConnection {
     ...
     * {@link org.bitcoingoldj.protocols.channels.PaymentChannelClient#DEFAULT_TIME_WINDOW}
     ...
     * Attempts to open a new connection to and open a payment channel with the given host and port, blocking until the
     * connection is open.  The server is requested to keep the channel open for
     * {@link org.bitcoingoldj.protocols.channels.PaymentChannelClient#DEFAULT_TIME_WINDOW} seconds.
